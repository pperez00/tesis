  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav p-2">
        <li class="nav-item">
          <a id="inicio" onclick="nav_boton(this.id)" class="nav-link" href="index.php?seccion=inicio">Inicio</a>
        </li>
        <li class="nav-item">
          <a id="quienes_somos" onclick="nav_boton(this.id)" class="nav-link" href="index.php?seccion=quienes_somos">Quienes somos</a>
        </li>
        <li class="nav-item">
          <a id="plan" onclick="nav_boton(this.id)" class="nav-link" href="index.php?seccion=plan">Plan</a>
        </li>
        <?php if ($id_user == 0) : ?>
          <li class="nav-item">
            <a id="login" onclick="nav_boton(this.id)" class="nav-link" href="index.php?seccion=login">Iniciar Sesion</a>
          </li>
        <?php
        endif;
        if ($id_user > 0) :
              ...
              <ul class="dropdown-menu" aria-labelledby="usuario_dropdown">
                ...
                <li class="nav-item dropdown dropdown-hover">
                  <a class="nav-link dropdown-toggle" id="juego_dropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fa-solid fa-gamepad"></i> Juego
                  </a>
